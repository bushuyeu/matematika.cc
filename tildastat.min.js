...
if(tildaParams.referrer==''){tildaParams.referrer=getCookie("previousUrl")||''}
if(tildaParams.page.substring(0,1)=='/'){tildaParams.page=w.location.protocol+'//'+w.location.hostname+tildaParams.page}
